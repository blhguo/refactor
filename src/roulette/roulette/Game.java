...
import roulette.roulette.bets.OddEven;
import roulette.roulette.bets.RedBlack;
import roulette.roulette.bets.ThreeConsecutive;
...
public class Game {
    ...
    private Bet promptForBet () {
        ...
        int whichBet = ConsoleReader.promptRange("Please make a choice", 1, myPossibleBets.length) - 1;
        return myPossibleBets[whichBet];
    }
}
